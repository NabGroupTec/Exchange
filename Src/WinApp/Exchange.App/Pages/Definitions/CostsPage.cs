...
{
    public partial class CostsPage : MetroForm
    {
        public CostsPage()
        {
        ...
        private void CostsPage_Load(object sender, EventArgs e)
        {
            ...
            using (var db = new UnitOfWork())
            {
                ...
                dgv.DataSource = db.CostRepository.GetAll();
            }
        }
        ...
        private void txtFind_TextChanged(object sender, EventArgs e)
        {
            using (var db = new UnitOfWork())
            {
                var result = db.CostRepository.Get(baseInfoGroup =>
        ...
        {
            using (var page = new AddCostPage())
            {
                page.ShowDialog();
            }

            CostsPage_Load(null, null);
        }
        ...
        private void EditRecord()
        {
            using (var page = new AddCostPage())
            {
                ...
                {
                    page.CostId = (int) dgv.CurrentRow.Cells["clnId"].Value;
                    page.ShowDialog();
                }
            }
        ...
        private void RemoveRecord()
        {
            ...
            if (dr == DialogResult.Yes)
                using (var dbContext = new UnitOfWork())
                {
                    ...
                    if (dgv.CurrentRow != null)
                    {
                        dbContext.CostRepository.Delete((int) dgv.CurrentRow.Cells["clnId"].Value);
                        dbContext.Save();
                    }
                }
