...
{
    public partial class IncomePage : MetroForm
    {
        public IncomePage()
        {
        ...
        private void IncomePage_Load(object sender, EventArgs e)
        {
            ...
            using (var db = new UnitOfWork())
            {
                ...
                dgv.DataSource = db.IncomeRepository.GetAll();
            }
        }
        ...
        private void txtFind_TextChanged(object sender, EventArgs e)
        {
            using (var db = new UnitOfWork())
            {
                var result = db.IncomeRepository.Get(income =>
                    income.Name.Contains(txtFind.Text));
        ...
        {
            using (var page = new AddIncomePage())
            {
                page.ShowDialog();
            }

            IncomePage_Load(null, null);
        }
        ...
        private void EditRecord()
        {
            using (var page = new AddIncomePage())
            {
                ...
                {
                    page.IncomeId = (int) dgv.CurrentRow.Cells["clnId"].Value;
                    page.ShowDialog();
                }
            }
        ...
        private void RemoveRecord()
        {
            ...
            if (dr == DialogResult.Yes)
                using (var dbContext = new UnitOfWork())
                {
                    ...
                    if (dgv.CurrentRow != null)
                    {
                        dbContext.IncomeRepository.Delete((int) dgv.CurrentRow.Cells["clnId"].Value);
                        dbContext.Save();
                    }
                }
        ...
        private void IncomePage_KeyDown(object sender, KeyEventArgs e)
        {
